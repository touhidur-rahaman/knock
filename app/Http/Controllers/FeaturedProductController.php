...
class FeaturedProductController extends CrudController{
    ...
    public function all($entity){
      parent::all($entity);
        ...
        // Simple code of  filter and grid part , List of all fields here : http://laravelpanel.com/docs/master/crud-fields
			...
			// $this->filter = \DataFilter::source(new \App\FeaturedProduct);
			// $this->filter->add('product_id', 'Product ID', 'text');
			// $this->filter->submit('search');
			// $this->filter->reset('reset');
			// $this->filter->build();

			$this->grid = \DataGrid::source(\App\FeaturedProduct::with('product_details'));
    ...
    public function  edit($entity){
      ...
      parent::edit($entity);
        ...
        // Simple code of  edit part , List of all fields here : http://laravelpanel.com/docs/master/crud-fields
			...
			$this->edit = \DataEdit::source(new \App\FeaturedProduct());

			$this->edit->label('Featured Products');

			$this->edit->add('product_id', 'Product ID', 'text')->rule('exists:products,id')->rule('unique:featured_products');
